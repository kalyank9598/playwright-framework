...
def read_json_data(file_path: str):
    ...
    [
        {"email": "test1@example.com", "password": "abc123", "expected": "valid"},
        {"email": "test2@example.com", "password": "xyz123", "expected": "invalid"}
    ]
    """
    data = []
    try:
        ...
        for record in json_data:
            #data.append((record["email"], record["password"], record["expected"]))
